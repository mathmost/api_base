...
class TestSession:
    ...
    def test_login_session(self, fix_login_session, something):
        ...
        print("TestSession获取login用例中设置的全局变量: ", case_data.globals_variable.get('global_login_res'))
        print("TestSession获取login用例中设置的局部变量: ", case_data.local_variable.get('local_login_status_code'))
